...
; File: "_kernel.c", produced by Gambit-C v4.5.3
(
405003
" _kernel"
(" _kernel")
...
#define ___GLO_COUNT 397
#define ___SUP_COUNT 397
#define ___SUB_COUNT 39
#define ___LBL_COUNT 945
#include "gambit.h"
...
___DEF_GLO(74," _kernel#8")
___DEF_GLO(75," _kernel#9")
___DEF_GLO(76,"##add-exit-job!")
___DEF_GLO(77,"##add-gc-interrupt-job!")
___DEF_GLO(78,"##add-job!")
___DEF_GLO(79,"##add-job-at-tail!")
___DEF_GLO(80,"##apply")
___DEF_GLO(81,"##apply-global-with-procedure-check-nary")

___DEF_GLO(82,"##apply-with-procedure-check")
___DEF_GLO(83,"##apply-with-procedure-check-nary")

___DEF_GLO(84,"##argument-list-fix-rest-param!")
___DEF_GLO(85,"##argument-list-remove-absent!")
___DEF_GLO(86,"##argument-list-remove-absent-keys!")

___DEF_GLO(87,"##bignum.adigit-width")
___DEF_GLO(88,"##bignum.fdigit-width")
___DEF_GLO(89,"##bignum.mdigit-width")
___DEF_GLO(90,"##check-heap")
___DEF_GLO(91,"##check-heap-limit")
___DEF_GLO(92,"##clear-exit-jobs!")
___DEF_GLO(93,"##clear-gc-interrupt-jobs!")
___DEF_GLO(94,"##clear-jobs!")
___DEF_GLO(95,"##closure-code")
___DEF_GLO(96,"##closure-length")
___DEF_GLO(97,"##closure-ref")
___DEF_GLO(98,"##closure-set!")
___DEF_GLO(99,"##closure?")
___DEF_GLO(100,"##command-line")
___DEF_GLO(101,"##continuation-copy")
___DEF_GLO(102,"##continuation-denv")
___DEF_GLO(103,"##continuation-frame")
___DEF_GLO(104,"##continuation-fs")
___DEF_GLO(105,"##continuation-link")
___DEF_GLO(106,"##continuation-next")
___DEF_GLO(107,"##continuation-next!")
___DEF_GLO(108,"##continuation-ref")
___DEF_GLO(109,"##continuation-ret")
___DEF_GLO(110,"##continuation-slot-live?")
___DEF_GLO(111,"##direct-structure-ref")
___DEF_GLO(112,"##direct-structure-set!")
___DEF_GLO(113,"##disable-interrupts!")
___DEF_GLO(114,"##dynamic-env-bind")
___DEF_GLO(115,"##enable-interrupts!")
___DEF_GLO(116,"##err-code-EAGAIN")
___DEF_GLO(117,"##err-code-EINTR")
___DEF_GLO(118,"##err-code-ENOENT")
___DEF_GLO(119,"##execute-and-clear-jobs!")
___DEF_GLO(120,"##execute-final-wills!")
___DEF_GLO(121,"##execute-jobs!")
___DEF_GLO(122,"##execute-modules")
___DEF_GLO(123,"##execute-program")
___DEF_GLO(124,"##exit")
___DEF_GLO(125,"##exit-abnormally")
___DEF_GLO(126,"##exit-cleanup")
___DEF_GLO(127,"##exit-jobs")
___DEF_GLO(128,"##exit-with-err-code")
___DEF_GLO(129,"##exit-with-err-code-no-cleanup")
___DEF_GLO(130,"##exit-with-exception")
___DEF_GLO(131,"##explode-continuation")
___DEF_GLO(132,"##explode-frame")
___DEF_GLO(133,"##extract-procedure-and-arguments")

___DEF_GLO(134,"##fail-check-cfun-conversion-exception")

___DEF_GLO(135,"##fail-check-foreign")
___DEF_GLO(136,"##fail-check-heap-overflow-exception")

___DEF_GLO(137,"##fail-check-keyword-expected-exception")

___DEF_GLO(138,"##fail-check-multiple-c-return-exception")

___DEF_GLO(139,"##fail-check-nonprocedure-operator-exception")

___DEF_GLO(140,"##fail-check-number-of-arguments-limit-exception")

___DEF_GLO(141,"##fail-check-os-exception")
___DEF_GLO(142,"##fail-check-sfun-conversion-exception")

___DEF_GLO(143,"##fail-check-stack-overflow-exception")

___DEF_GLO(144,"##fail-check-type-exception")
___DEF_GLO(145,"##fail-check-unknown-keyword-argument-exception")

___DEF_GLO(146,"##fail-check-wrong-number-of-arguments-exception")

___DEF_GLO(147,"##final-will-registry")
___DEF_GLO(148,"##find-interned-keyword")
___DEF_GLO(149,"##find-interned-symbol")
___DEF_GLO(150,"##find-interned-symkey")
___DEF_GLO(151,"##first-argument")
___DEF_GLO(152,"##fixnum-width")
___DEF_GLO(153,"##fixnum-width-neg")
___DEF_GLO(154,"##force-undetermined")
___DEF_GLO(155,"##foreign-address")
___DEF_GLO(156,"##foreign-release!")
___DEF_GLO(157,"##foreign-released?")
___DEF_GLO(158,"##foreign-tags")
___DEF_GLO(159,"##format-filepos")
___DEF_GLO(160,"##frame-fs")
___DEF_GLO(161,"##frame-link")
___DEF_GLO(162,"##frame-ref")
___DEF_GLO(163,"##frame-ret")
___DEF_GLO(164,"##frame-slot-live?")
___DEF_GLO(165,"##gc")
___DEF_GLO(166,"##gc-final-will-registry!")
___DEF_GLO(167,"##gc-finalize!")
___DEF_GLO(168,"##gc-interrupt-jobs")
___DEF_GLO(169,"##gc-without-exceptions")
___DEF_GLO(170,"##get-current-time!")
___DEF_GLO(171,"##get-live-percent")
___DEF_GLO(172,"##get-max-heap")
___DEF_GLO(173,"##get-min-heap")
___DEF_GLO(174,"##get-standard-level")
___DEF_GLO(175,"##global-var->identifier")
___DEF_GLO(176,"##global-var-primitive-ref")
___DEF_GLO(177,"##global-var-primitive-set!")
___DEF_GLO(178,"##global-var-ref")
___DEF_GLO(179,"##global-var-set!")
___DEF_GLO(180,"##global-var?")
___DEF_GLO(181,"##heartbeat-interval-set!")
___DEF_GLO(182,"##interrupt-handler")
___DEF_GLO(183,"##interrupt-vector")
___DEF_GLO(184,"##interrupt-vector-set!")
___DEF_GLO(185,"##kernel-handlers")
___DEF_GLO(186,"##keyword-table")
___DEF_GLO(187,"##main")
___DEF_GLO(188,"##main-set!")
___DEF_GLO(189,"##make-f32vector")
___DEF_GLO(190,"##make-f64vector")
___DEF_GLO(191,"##make-final-will")
___DEF_GLO(192,"##make-global-var")
___DEF_GLO(193,"##make-interned-keyword")
___DEF_GLO(194,"##make-interned-symbol")
___DEF_GLO(195,"##make-interned-symkey")
___DEF_GLO(196,"##make-jobs")
...
___DEF_GLO(202,"##make-subprocedure")
___DEF_GLO(203,"##make-u16vector")
___DEF_GLO(204,"##make-u32vector")
___DEF_GLO(205,"##make-u64vector")
___DEF_GLO(206,"##make-u8vector")
___DEF_GLO(207,"##make-vector")
___DEF_GLO(208,"##max-char")
___DEF_GLO(209,"##max-fixnum")
___DEF_GLO(210,"##min-fixnum")
___DEF_GLO(211,"##object->global-var")
___DEF_GLO(212,"##object->global-var->identifier")
___DEF_GLO(213,"##os-address-infos")
___DEF_GLO(214,"##os-condvar-select!")
___DEF_GLO(215,"##os-configure-command-string-saved")

___DEF_GLO(216,"##os-copy-file")
___DEF_GLO(217,"##os-create-directory")
___DEF_GLO(218,"##os-create-fifo")
___DEF_GLO(219,"##os-create-link")
___DEF_GLO(220,"##os-create-symbolic-link")
___DEF_GLO(221,"##os-delete-directory")
___DEF_GLO(222,"##os-delete-file")
___DEF_GLO(223,"##os-device-close")
___DEF_GLO(224,"##os-device-directory-open-path")
___DEF_GLO(225,"##os-device-directory-read")
___DEF_GLO(226,"##os-device-event-queue-open")
___DEF_GLO(227,"##os-device-event-queue-read")
___DEF_GLO(228,"##os-device-force-output")
___DEF_GLO(229,"##os-device-kind")
___DEF_GLO(230,"##os-device-process-pid")
___DEF_GLO(231,"##os-device-process-status")
___DEF_GLO(232,"##os-device-stream-default-options")

___DEF_GLO(233,"##os-device-stream-open-path")
___DEF_GLO(234,"##os-device-stream-open-predefined")

___DEF_GLO(235,"##os-device-stream-open-process")
___DEF_GLO(236,"##os-device-stream-options-set!")
___DEF_GLO(237,"##os-device-stream-read")
___DEF_GLO(238,"##os-device-stream-seek")
___DEF_GLO(239,"##os-device-stream-width")
___DEF_GLO(240,"##os-device-stream-write")
___DEF_GLO(241,"##os-device-tcp-client-open")
___DEF_GLO(242,"##os-device-tcp-client-socket-info")

___DEF_GLO(243,"##os-device-tcp-server-open")
___DEF_GLO(244,"##os-device-tcp-server-read")
___DEF_GLO(245,"##os-device-tcp-server-socket-info")

___DEF_GLO(246,"##os-device-tty-history")
___DEF_GLO(247,"##os-device-tty-history-max-length-set!")

___DEF_GLO(248,"##os-device-tty-history-set!")
___DEF_GLO(249,"##os-device-tty-mode-set!")
___DEF_GLO(250,"##os-device-tty-paren-balance-duration-set!")

___DEF_GLO(251,"##os-device-tty-text-attributes-set!")

___DEF_GLO(252,"##os-device-tty-type-set!")
___DEF_GLO(253,"##os-environ")
___DEF_GLO(254,"##os-err-code->string")
___DEF_GLO(255,"##os-exe-extension-string-saved")
___DEF_GLO(256,"##os-file-info")
___DEF_GLO(257,"##os-getenv")
___DEF_GLO(258,"##os-getpid")
___DEF_GLO(259,"##os-getppid")
___DEF_GLO(260,"##os-group-info")
___DEF_GLO(261,"##os-host-info")
___DEF_GLO(262,"##os-host-name")
___DEF_GLO(263,"##os-load-object-file")
___DEF_GLO(264,"##os-network-info")
___DEF_GLO(265,"##os-obj-extension-string-saved")
___DEF_GLO(266,"##os-path-gambcdir")
___DEF_GLO(267,"##os-path-gambcdir-map-lookup")
___DEF_GLO(268,"##os-path-homedir")
___DEF_GLO(269,"##os-path-normalize-directory")
___DEF_GLO(270,"##os-port-decode-chars!")
___DEF_GLO(271,"##os-port-encode-chars!")
___DEF_GLO(272,"##os-protocol-info")
___DEF_GLO(273,"##os-rename-file")
___DEF_GLO(274,"##os-service-info")
___DEF_GLO(275,"##os-set-current-directory")
___DEF_GLO(276,"##os-setenv")
___DEF_GLO(277,"##os-shell-command")
___DEF_GLO(278,"##os-system-type-saved")
___DEF_GLO(279,"##os-system-type-string-saved")
___DEF_GLO(280,"##os-user-info")
___DEF_GLO(281,"##os-user-name")
___DEF_GLO(282,"##process-statistics")
___DEF_GLO(283,"##process-times")
___DEF_GLO(284,"##processed-command-line")
___DEF_GLO(285,"##program-descr")
___DEF_GLO(286,"##raise-cfun-conversion-exception-nary")

___DEF_GLO(287,"##raise-heap-overflow-exception")
___DEF_GLO(288,"##raise-keyword-expected-exception")

___DEF_GLO(289,"##raise-keyword-expected-exception-nary")

___DEF_GLO(290,"##raise-multiple-c-return-exception")

___DEF_GLO(291,"##raise-nonprocedure-operator-exception")

___DEF_GLO(292,"##raise-number-of-arguments-limit-exception")

___DEF_GLO(293,"##raise-os-exception")
___DEF_GLO(294,"##raise-sfun-conversion-exception")

___DEF_GLO(295,"##raise-stack-overflow-exception")
___DEF_GLO(296,"##raise-type-exception")
___DEF_GLO(297,"##raise-unknown-keyword-argument-exception")

___DEF_GLO(298,"##raise-unknown-keyword-argument-exception-nary")

___DEF_GLO(299,"##raise-wrong-number-of-arguments-exception")

___DEF_GLO(300,"##raise-wrong-number-of-arguments-exception-nary")

___DEF_GLO(301,"##remote-dbg-addr")
___DEF_GLO(302,"##rest-param-check-heap")
___DEF_GLO(303,"##rest-param-heap-overflow")
___DEF_GLO(304,"##rest-param-resume-procedure")
___DEF_GLO(305,"##return-fs")
___DEF_GLO(306,"##rpc-server-addr")
___DEF_GLO(307,"##set-debug-settings!")
___DEF_GLO(308,"##set-live-percent!")
___DEF_GLO(309,"##set-max-heap!")
___DEF_GLO(310,"##set-min-heap!")
___DEF_GLO(311,"##set-standard-level!")
___DEF_GLO(312,"##still-copy")
___DEF_GLO(313,"##still-obj-refcount-dec!")
___DEF_GLO(314,"##still-obj-refcount-inc!")
___DEF_GLO(315,"##structure")
___DEF_GLO(316,"##structure-direct-instance-of?")
___DEF_GLO(317,"##structure-instance-of?")
___DEF_GLO(318,"##structure-ref")
___DEF_GLO(319,"##structure-set!")
___DEF_GLO(320,"##structure-type")
___DEF_GLO(321,"##structure-type-set!")
___DEF_GLO(322,"##subprocedure-id")
___DEF_GLO(323,"##subprocedure-nb-closed")
___DEF_GLO(324,"##subprocedure-nb-parameters")
___DEF_GLO(325,"##subprocedure-parent")
___DEF_GLO(326,"##subprocedure-parent-info")
___DEF_GLO(327,"##subprocedure-parent-name")
___DEF_GLO(328,"##subprocedure?")
___DEF_GLO(329,"##symbol-table")
...
___DEF_GLO(340,"##type?")
___DEF_GLO(341,"##unchecked-structure-ref")
___DEF_GLO(342,"##unchecked-structure-set!")
___DEF_GLO(343,"##with-no-result-expected")
___DEF_GLO(344,"##with-no-result-expected-toplevel")

___DEF_GLO(345,"cfun-conversion-exception-arguments")

___DEF_GLO(346,"cfun-conversion-exception-code")
___DEF_GLO(347,"cfun-conversion-exception-message")

___DEF_GLO(348,"cfun-conversion-exception-procedure")

___DEF_GLO(349,"cfun-conversion-exception?")
___DEF_GLO(350,"configure-command-string")
___DEF_GLO(351,"err-code->string")
___DEF_GLO(352,"foreign-address")
___DEF_GLO(353,"foreign-release!")
___DEF_GLO(354,"foreign-released?")
___DEF_GLO(355,"foreign-tags")
___DEF_GLO(356,"foreign?")
___DEF_GLO(357,"heap-overflow-exception?")
___DEF_GLO(358,"keyword-expected-exception-arguments")

___DEF_GLO(359,"keyword-expected-exception-procedure")

___DEF_GLO(360,"keyword-expected-exception?")
___DEF_GLO(361,"multiple-c-return-exception?")
___DEF_GLO(362,"nonprocedure-operator-exception-arguments")

___DEF_GLO(363,"nonprocedure-operator-exception-code")

___DEF_GLO(364,"nonprocedure-operator-exception-operator")

___DEF_GLO(365,"nonprocedure-operator-exception-rte")

___DEF_GLO(366,"nonprocedure-operator-exception?")
___DEF_GLO(367,"number-of-arguments-limit-exception-arguments")

___DEF_GLO(368,"number-of-arguments-limit-exception-procedure")

___DEF_GLO(369,"number-of-arguments-limit-exception?")

___DEF_GLO(370,"os-exception-arguments")
___DEF_GLO(371,"os-exception-code")
___DEF_GLO(372,"os-exception-message")
___DEF_GLO(373,"os-exception-procedure")
___DEF_GLO(374,"os-exception?")
___DEF_GLO(375,"sfun-conversion-exception-arguments")

___DEF_GLO(376,"sfun-conversion-exception-code")
___DEF_GLO(377,"sfun-conversion-exception-message")

___DEF_GLO(378,"sfun-conversion-exception-procedure")

___DEF_GLO(379,"sfun-conversion-exception?")
___DEF_GLO(380,"stack-overflow-exception?")
___DEF_GLO(381,"system-stamp")
___DEF_GLO(382,"system-type")
___DEF_GLO(383,"system-type-string")
___DEF_GLO(384,"system-version")
___DEF_GLO(385,"system-version-string")
___DEF_GLO(386,"type-exception-arg-num")
___DEF_GLO(387,"type-exception-arguments")
___DEF_GLO(388,"type-exception-procedure")
___DEF_GLO(389,"type-exception-type-id")
___DEF_GLO(390,"type-exception?")
___DEF_GLO(391,"unknown-keyword-argument-exception-arguments")

___DEF_GLO(392,"unknown-keyword-argument-exception-procedure")

___DEF_GLO(393,"unknown-keyword-argument-exception?")

___DEF_GLO(394,"wrong-number-of-arguments-exception-arguments")

___DEF_GLO(395,"wrong-number-of-arguments-exception-procedure")

___DEF_GLO(396,"wrong-number-of-arguments-exception?")
...
___DEF_GLBL(___L__20___kernel)
   ...
   ___SET_GLO(183,___G__23__23_interrupt_2d_vector,___R1)
   ___SET_STK(1,___R0)
   ___SET_R0(___LBL(3))
   ___ADJFP(4)
...
___DEF_SLBL(2,___L2__20___kernel)
   ___JUMPINT(___SET_NARGS(0),___PRC(284),___L__23__23_make_2d_jobs)
___DEF_SLBL(3,___L3__20___kernel)
   ___SET_GLO(168,___G__23__23_gc_2d_interrupt_2d_jobs,___R1)
   ___SET_R1(___CONS(___NUL,___NUL))
   ___SETCAR(___R1,___R1)
   ___SET_GLO(147,___G__23__23_final_2d_will_2d_registry,___R1)
   ___SET_R2(___LBL(23))
   ___SET_R1(___FIX(2L))
   ___SET_R0(___LBL(5))
   ___CHECK_HEAP(4,4096)
___DEF_SLBL(4,___L4__20___kernel)
   ___JUMPINT(___SET_NARGS(2),___PRC(51),___L__23__23_interrupt_2d_vector_2d_set_21_)
___DEF_SLBL(5,___L5__20___kernel)
   ...
   ___SET_R0(___LBL(6))
   ___JUMPINT(___SET_NARGS(0),___PRC(727),___L__20___kernel_23_3)
___DEF_SLBL(6,___L6__20___kernel)
   ___SET_R0(___LBL(12))
   ___IF(___NULLP(___R1))
   ___GOTO(___L26__20___kernel)
   ___END_IF
   ___GOTO(___L25__20___kernel)
___DEF_SLBL(7,___L7__20___kernel)
   ...
   ___GOTO(___L26__20___kernel)
   ___END_IF
___DEF_GLBL(___L25__20___kernel)
   ___SET_STK(1,___R0)
   ___SET_STK(2,___R1)
...
___DEF_SLBL(8,___L8__20___kernel)
   ___JUMPINT(___SET_NARGS(1),___PRC(559),___L__23__23_make_2d_interned_2d_symbol)
...
___DEF_SLBL(12,___L12__20___kernel)
   ___SET_GLO(278,___G__23__23_os_2d_system_2d_type_2d_saved,___R1)
   ___SET_R0(___LBL(13))
   ___JUMPINT(___SET_NARGS(0),___PRC(730),___L__20___kernel_23_4)
___DEF_SLBL(13,___L13__20___kernel)
   ___SET_GLO(279,___G__23__23_os_2d_system_2d_type_2d_string_2d_saved,___R1)
   ___SET_R0(___LBL(14))
   ___JUMPINT(___SET_NARGS(0),___PRC(733),___L__20___kernel_23_5)
___DEF_SLBL(14,___L14__20___kernel)
   ___SET_GLO(215,___G__23__23_os_2d_configure_2d_command_2d_string_2d_saved,___R1)
   ___SET_R0(___LBL(15))
   ___JUMPINT(___SET_NARGS(0),___PRC(736),___L__20___kernel_23_6)
___DEF_SLBL(15,___L15__20___kernel)
   ___SET_GLO(331,___G__23__23_system_2d_stamp_2d_saved,___R1)
   ___SET_R0(___LBL(16))
   ___JUMPINT(___SET_NARGS(0),___PRC(739),___L__20___kernel_23_7)
___DEF_SLBL(16,___L16__20___kernel)
   ___SET_GLO(265,___G__23__23_os_2d_obj_2d_extension_2d_string_2d_saved,___R1)
   ___SET_R0(___LBL(17))
   ___JUMPINT(___SET_NARGS(0),___PRC(742),___L__20___kernel_23_8)
___DEF_SLBL(17,___L17__20___kernel)
   ___SET_GLO(255,___G__23__23_os_2d_exe_2d_extension_2d_string_2d_saved,___R1)
{ ___SCMOBJ ___RESULT;
___RESULT = ___FIX(___ERRNO_ERR(EAGAIN));
   ___SET_R1(___RESULT)
}
   ___SET_GLO(116,___G__23__23_err_2d_code_2d_EAGAIN,___R1)
{ ___SCMOBJ ___RESULT;
___RESULT = ___FIX(___ERRNO_ERR(ENOENT));
   ___SET_R1(___RESULT)
}
   ___SET_GLO(118,___G__23__23_err_2d_code_2d_ENOENT,___R1)
{ ___SCMOBJ ___RESULT;
___RESULT = ___FIX(___ERRNO_ERR(EINTR));
   ___SET_R1(___RESULT)
}
   ___SET_GLO(117,___G__23__23_err_2d_code_2d_EINTR,___R1)
{ ___SCMOBJ ___RESULT;
___RESULT = ___FIX(___MAX_CHR);
   ___SET_R1(___RESULT)
}
   ___SET_GLO(208,___G__23__23_max_2d_char,___R1)
{ ___SCMOBJ ___RESULT;
___RESULT = ___FIX(___MIN_FIX);
   ___SET_R1(___RESULT)
}
   ___SET_GLO(210,___G__23__23_min_2d_fixnum,___R1)
{ ___SCMOBJ ___RESULT;
___RESULT = ___FIX(___MAX_FIX);
   ___SET_R1(___RESULT)
}
   ___SET_GLO(209,___G__23__23_max_2d_fixnum,___R1)
{ ___SCMOBJ ___RESULT;
___RESULT = ___FIX(___FIX_WIDTH);
   ___SET_R1(___RESULT)
}
   ___SET_GLO(152,___G__23__23_fixnum_2d_width,___R1)
   ___SET_R1(___FIXNEG(___GLO(152,___G__23__23_fixnum_2d_width)))
   ___SET_GLO(153,___G__23__23_fixnum_2d_width_2d_neg,___R1)
{ ___SCMOBJ ___RESULT;
___RESULT = ___FIX(___BIG_ABASE_WIDTH);
   ___SET_R1(___RESULT)
}
   ___SET_GLO(87,___G__23__23_bignum_2e_adigit_2d_width,___R1)
{ ___SCMOBJ ___RESULT;
___RESULT = ___FIX(___BIG_MBASE_WIDTH);
   ___SET_R1(___RESULT)
}
   ___SET_GLO(89,___G__23__23_bignum_2e_mdigit_2d_width,___R1)
{ ___SCMOBJ ___RESULT;
___RESULT = ___FIX(___BIG_FBASE_WIDTH);
   ___SET_R1(___RESULT)
}
   ___SET_GLO(88,___G__23__23_bignum_2e_fdigit_2d_width,___R1)
   ___SET_GLO(159,___G__23__23_format_2d_filepos,___PRC(745))
   ___SET_GLO(254,___G__23__23_os_2d_err_2d_code_2d__3e_string,___PRC(748))
   ___SET_GLO(268,___G__23__23_os_2d_path_2d_homedir,___PRC(751))
   ___SET_GLO(266,___G__23__23_os_2d_path_2d_gambcdir,___PRC(754))
   ___SET_GLO(267,___G__23__23_os_2d_path_2d_gambcdir_2d_map_2d_lookup,___PRC(757))
   ___SET_GLO(269,___G__23__23_os_2d_path_2d_normalize_2d_directory,___PRC(760))
   ___SET_GLO(301,___G__23__23_remote_2d_dbg_2d_addr,___PRC(763))
   ___SET_GLO(306,___G__23__23_rpc_2d_server_2d_addr,___PRC(766))
   ___SET_GLO(284,___G__23__23_processed_2d_command_2d_line,___NUL)
   ___SET_R0(___LBL(18))
   ___JUMPINT(___SET_NARGS(0),___PRC(673),___L__23__23_command_2d_line)
___DEF_SLBL(18,___L18__20___kernel)
   ___SET_GLO(284,___G__23__23_processed_2d_command_2d_line,___R1)
   ___SET_GLO(257,___G__23__23_os_2d_getenv,___PRC(769))
   ___SET_GLO(276,___G__23__23_os_2d_setenv,___PRC(772))
   ___SET_GLO(253,___G__23__23_os_2d_environ,___PRC(775))
   ___SET_GLO(277,___G__23__23_os_2d_shell_2d_command,___PRC(778))
   ___SET_GLO(229,___G__23__23_os_2d_device_2d_kind,___PRC(781))
   ___SET_GLO(228,___G__23__23_os_2d_device_2d_force_2d_output,___PRC(784))
   ___SET_GLO(223,___G__23__23_os_2d_device_2d_close,___PRC(787))
   ___SET_GLO(238,___G__23__23_os_2d_device_2d_stream_2d_seek,___PRC(790))
   ___SET_GLO(237,___G__23__23_os_2d_device_2d_stream_2d_read,___PRC(793))
   ___SET_GLO(240,___G__23__23_os_2d_device_2d_stream_2d_write,___PRC(796))
   ___SET_GLO(239,___G__23__23_os_2d_device_2d_stream_2d_width,___PRC(799))
   ___SET_GLO(232,___G__23__23_os_2d_device_2d_stream_2d_default_2d_options,___PRC(802))
   ___SET_GLO(236,___G__23__23_os_2d_device_2d_stream_2d_options_2d_set_21_,___PRC(805))
   ___SET_GLO(234,___G__23__23_os_2d_device_2d_stream_2d_open_2d_predefined,___PRC(808))
   ___SET_GLO(233,___G__23__23_os_2d_device_2d_stream_2d_open_2d_path,___PRC(811))
   ___SET_GLO(235,___G__23__23_os_2d_device_2d_stream_2d_open_2d_process,___PRC(814))
   ___SET_GLO(230,___G__23__23_os_2d_device_2d_process_2d_pid,___PRC(817))
   ___SET_GLO(231,___G__23__23_os_2d_device_2d_process_2d_status,___PRC(820))
   ___SET_GLO(241,___G__23__23_os_2d_device_2d_tcp_2d_client_2d_open,___PRC(823))
   ___SET_GLO(242,___G__23__23_os_2d_device_2d_tcp_2d_client_2d_socket_2d_info,___PRC(826))
   ___SET_GLO(243,___G__23__23_os_2d_device_2d_tcp_2d_server_2d_open,___PRC(829))
   ___SET_GLO(244,___G__23__23_os_2d_device_2d_tcp_2d_server_2d_read,___PRC(832))
   ___SET_GLO(245,___G__23__23_os_2d_device_2d_tcp_2d_server_2d_socket_2d_info,___PRC(835))
   ___SET_GLO(224,___G__23__23_os_2d_device_2d_directory_2d_open_2d_path,___PRC(838))
   ___SET_GLO(225,___G__23__23_os_2d_device_2d_directory_2d_read,___PRC(841))
   ___SET_GLO(226,___G__23__23_os_2d_device_2d_event_2d_queue_2d_open,___PRC(844))
   ___SET_GLO(227,___G__23__23_os_2d_device_2d_event_2d_queue_2d_read,___PRC(847))
   ___SET_GLO(252,___G__23__23_os_2d_device_2d_tty_2d_type_2d_set_21_,___PRC(850))
   ___SET_GLO(251,___G__23__23_os_2d_device_2d_tty_2d_text_2d_attributes_2d_set_21_,___PRC(853))
   ___SET_GLO(246,___G__23__23_os_2d_device_2d_tty_2d_history,___PRC(856))
   ___SET_GLO(248,___G__23__23_os_2d_device_2d_tty_2d_history_2d_set_21_,___PRC(859))
   ___SET_GLO(247,___G__23__23_os_2d_device_2d_tty_2d_history_2d_max_2d_length_2d_set_21_,___PRC(862))
   ___SET_GLO(250,___G__23__23_os_2d_device_2d_tty_2d_paren_2d_balance_2d_duration_2d_set_21_,___PRC(865))
   ___SET_GLO(249,___G__23__23_os_2d_device_2d_tty_2d_mode_2d_set_21_,___PRC(868))
   ___SET_GLO(270,___G__23__23_os_2d_port_2d_decode_2d_chars_21_,___PRC(871))
   ___SET_GLO(271,___G__23__23_os_2d_port_2d_encode_2d_chars_21_,___PRC(874))
   ___SET_GLO(256,___G__23__23_os_2d_file_2d_info,___PRC(877))
   ___SET_GLO(280,___G__23__23_os_2d_user_2d_info,___PRC(880))
   ___SET_GLO(281,___G__23__23_os_2d_user_2d_name,___PRC(883))
   ___SET_GLO(260,___G__23__23_os_2d_group_2d_info,___PRC(886))
   ___SET_GLO(213,___G__23__23_os_2d_address_2d_infos,___PRC(889))
   ___SET_GLO(261,___G__23__23_os_2d_host_2d_info,___PRC(892))
   ___SET_GLO(262,___G__23__23_os_2d_host_2d_name,___PRC(895))
   ___SET_GLO(274,___G__23__23_os_2d_service_2d_info,___PRC(898))
   ___SET_GLO(272,___G__23__23_os_2d_protocol_2d_info,___PRC(901))
   ___SET_GLO(264,___G__23__23_os_2d_network_2d_info,___PRC(904))
   ___SET_GLO(258,___G__23__23_os_2d_getpid,___PRC(907))
   ___SET_GLO(259,___G__23__23_os_2d_getppid,___PRC(910))
   ___SET_GLO(217,___G__23__23_os_2d_create_2d_directory,___PRC(913))
   ___SET_GLO(218,___G__23__23_os_2d_create_2d_fifo,___PRC(916))
   ___SET_GLO(219,___G__23__23_os_2d_create_2d_link,___PRC(919))
   ___SET_GLO(220,___G__23__23_os_2d_create_2d_symbolic_2d_link,___PRC(922))
   ___SET_GLO(221,___G__23__23_os_2d_delete_2d_directory,___PRC(925))
   ___SET_GLO(275,___G__23__23_os_2d_set_2d_current_2d_directory,___PRC(928))
   ___SET_GLO(273,___G__23__23_os_2d_rename_2d_file,___PRC(931))
   ___SET_GLO(216,___G__23__23_os_2d_copy_2d_file,___PRC(934))
   ___SET_GLO(222,___G__23__23_os_2d_delete_2d_file,___PRC(937))
   ___SET_GLO(263,___G__23__23_os_2d_load_2d_object_2d_file,___PRC(940))
   ___SET_R0(___LBL(19))
   ___JUMPINT(___SET_NARGS(0),___PRC(284),___L__23__23_make_2d_jobs)
___DEF_SLBL(19,___L19__20___kernel)
   ___SET_GLO(127,___G__23__23_exit_2d_jobs,___R1)
   ___SET_R2(___LBL(22))
   ___SET_R1(___FIX(3L))
   ___SET_R0(___LBL(20))
   ___JUMPINT(___SET_NARGS(2),___PRC(51),___L__23__23_interrupt_2d_vector_2d_set_21_)
...
{ ___SCMOBJ ___RESULT;
   ...
   ___SET_GLO(285,___G__23__23_program_2d_descr,___R1)
   ___SET_GLO(187,___G__23__23_main,___PRC(943))
   ___SET_R0(___STK(-3))
   ___POLL(21)
___DEF_SLBL(21,___L21__20___kernel)
   ___ADJFP(-4)
   ___JUMPINT(___SET_NARGS(0),___PRC(713),___L__23__23_execute_2d_program)
___DEF_SLBL(22,___L22__20___kernel)
   ___IF_NARGS_EQ(0,___NOTHING)
   ___WRONG_NARGS(22,0,0,0)
   ___JUMPINT(___SET_NARGS(0),___PRC(698),___L__23__23_exit_2d_abnormally)
___DEF_SLBL(23,___L23__20___kernel)
   ...
   ___SET_R0(___LBL(24))
   ___ADJFP(4)
   ___JUMPINT(___SET_NARGS(0),___PRC(336),___L__23__23_gc_2d_finalize_21_)
___DEF_SLBL(24,___L24__20___kernel)
   ___SET_R1(___GLO(168,___G__23__23_gc_2d_interrupt_2d_jobs))
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPINT(___SET_NARGS(1),___PRC(293),___L__23__23_execute_2d_jobs_21_)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_dynamic_2d_env_2d_bind)
   ...
   ___UNCHECKEDSTRUCTURESET(___R2,___STK(-2),___FIX(20L),___SUB(2),___FAL)
...
___DEF_GLBL(___L__23__23_interrupt_2d_handler)
   ___SET_R1(___VECTORREF(___GLO(183,___G__23__23_interrupt_2d_vector),___R1))
...
___DEF_GLBL(___L__23__23_interrupt_2d_vector_2d_set_21_)
   ___VECTORSET(___GLO(183,___G__23__23_interrupt_2d_vector),___R1,___R2) ___SET_R1(___GLO(183,___G__23__23_interrupt_2d_vector))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_fail_2d_check_2d_heap_2d_overflow_2d_exception)
   ___JUMPINT(___SET_NARGS(4),___PRC(223),___L__23__23_raise_2d_type_2d_exception)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_raise_2d_heap_2d_overflow_2d_exception)
   ___SET_R1(___LBL(1))
   ___JUMPINT(___SET_NARGS(1),___PRC(656),___L__23__23_with_2d_no_2d_result_2d_expected)
...
___DEF_SLBL(1,___L1_nonprocedure_2d_operator_2d_exception_2d_operator)
   ___SET_NARGS(3) ___JUMPINT(___NOTHING,___PRC(71),___L0__23__23_fail_2d_check_2d_nonprocedure_2d_operator_2d_exception)
...
___DEF_GLBL(___L__23__23_apply_2d_global_2d_with_2d_procedure_2d_check_2d_nary)
   ...
   ___JUMPINT(___SET_NARGS(2),___PRC(92),___L__23__23_apply_2d_with_2d_procedure_2d_check)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_apply_2d_with_2d_procedure_2d_check)
   ...
   ___SET_R2(___FAL)
   ___ADJFP(1)
   ___JUMPINT(___SET_NARGS(4),___PRC(94),___L__23__23_raise_2d_nonprocedure_2d_operator_2d_exception)
___DEF_GLBL(___L1__23__23_apply_2d_with_2d_procedure_2d_check)
   ___JUMPPRM(___SET_NARGS(2),___PRM(80,___G__23__23_apply))
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_wrong_2d_number_2d_of_2d_arguments_2d_exception_2d_procedure)
   ___SET_NARGS(3) ___JUMPINT(___NOTHING,___PRC(97),___L0__23__23_fail_2d_check_2d_wrong_2d_number_2d_of_2d_arguments_2d_exception)
...
___DEF_GLBL(___L__23__23_raise_2d_wrong_2d_number_2d_of_2d_arguments_2d_exception_2d_nary)
   ___JUMPINT(___SET_NARGS(2),___PRC(110),___L__23__23_raise_2d_wrong_2d_number_2d_of_2d_arguments_2d_exception)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_keyword_2d_expected_2d_exception_2d_procedure)
   ___SET_NARGS(3) ___JUMPINT(___NOTHING,___PRC(113),___L0__23__23_fail_2d_check_2d_keyword_2d_expected_2d_exception)
...
___DEF_GLBL(___L__23__23_raise_2d_keyword_2d_expected_2d_exception_2d_nary)
   ___JUMPINT(___SET_NARGS(2),___PRC(126),___L__23__23_raise_2d_keyword_2d_expected_2d_exception)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_unknown_2d_keyword_2d_argument_2d_exception_2d_procedure)
   ___SET_NARGS(3) ___JUMPINT(___NOTHING,___PRC(129),___L0__23__23_fail_2d_check_2d_unknown_2d_keyword_2d_argument_2d_exception)
...
___DEF_GLBL(___L__23__23_raise_2d_unknown_2d_keyword_2d_argument_2d_exception_2d_nary)
   ___JUMPINT(___SET_NARGS(2),___PRC(142),___L__23__23_raise_2d_unknown_2d_keyword_2d_argument_2d_exception)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_cfun_2d_conversion_2d_exception_2d_procedure)
   ___SET_NARGS(3) ___JUMPINT(___NOTHING,___PRC(145),___L0__23__23_fail_2d_check_2d_cfun_2d_conversion_2d_exception)
...
___DEF_SLBL(1,___L1_sfun_2d_conversion_2d_exception_2d_procedure)
   ___SET_NARGS(3) ___JUMPINT(___NOTHING,___PRC(165),___L0__23__23_fail_2d_check_2d_sfun_2d_conversion_2d_exception)
...
___DEF_SLBL(1,___L1_number_2d_of_2d_arguments_2d_limit_2d_exception_2d_procedure)
   ___SET_NARGS(3) ___JUMPINT(___NOTHING,___PRC(192),___L0__23__23_fail_2d_check_2d_number_2d_of_2d_arguments_2d_limit_2d_exception)
...
___DEF_SLBL(1,___L1_type_2d_exception_2d_procedure)
   ___SET_NARGS(3) ___JUMPINT(___NOTHING,___PRC(206),___L0__23__23_fail_2d_check_2d_type_2d_exception)
...
___DEF_SLBL(1,___L1__23__23_raise_2d_type_2d_exception)
   ___JUMPINT(___SET_NARGS(6),___PRC(267),___L__23__23_extract_2d_procedure_2d_and_2d_arguments)
...
___DEF_SLBL(1,___L1_os_2d_exception_2d_procedure)
   ___SET_NARGS(3) ___JUMPINT(___NOTHING,___PRC(229),___L0__23__23_fail_2d_check_2d_os_2d_exception)
...
___DEF_SLBL(2,___L2__23__23_raise_2d_os_2d_exception)
   ___IF_NARGS_EQ(5,___NOTHING)
   ___WRONG_NARGS(2,5,0,0)
   ___IF(___NOT(___FIXEQ(___R2,___GLO(118,___G__23__23_err_2d_code_2d_ENOENT))))
...
___DEF_SLBL(1,___L1__23__23_extract_2d_procedure_2d_and_2d_arguments)
   ___JUMPINT(___SET_NARGS(1),___PRC(263),___L__23__23_argument_2d_list_2d_fix_2d_rest_2d_param_21_)
___DEF_SLBL(2,___L2__23__23_extract_2d_procedure_2d_and_2d_arguments)
   ___SET_R2(___NUL)
   ___SET_R0(___LBL(3))
   ___JUMPINT(___SET_NARGS(2),___PRC(253),___L__23__23_argument_2d_list_2d_remove_2d_absent_21_)
...
___DEF_SLBL(5,___L5__23__23_extract_2d_procedure_2d_and_2d_arguments)
   ___JUMPINT(___SET_NARGS(1),___PRC(258),___L__23__23_argument_2d_list_2d_remove_2d_absent_2d_keys_21_)
...
{ ___SCMOBJ ___RESULT;
   ...
   ___SET_R0(___LBL(1))
   ___ADJFP(4)
   ___JUMPINT(___SET_NARGS(0),___PRC(60),___L__23__23_raise_2d_heap_2d_overflow_2d_exception)
...
___DEF_GLBL(___L3__23__23_rest_2d_param_2d_check_2d_heap)
   ...
   ___SET_R0(___LBL(2))
   ___ADJFP(4)
   ___JUMPINT(___SET_NARGS(0),___PRC(323),___L__23__23_gc_2d_without_2d_exceptions)
...
___DEF_GLBL(___L4__23__23_rest_2d_param_2d_check_2d_heap)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPINT(___SET_NARGS(2),___PRC(321),___L__23__23_rest_2d_param_2d_resume_2d_procedure)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_add_2d_gc_2d_interrupt_2d_job_21_)
   ___JUMPINT(___SET_NARGS(2),___PRC(290),___L__23__23_add_2d_job_21_)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_clear_2d_gc_2d_interrupt_2d_jobs_21_)
   ___JUMPINT(___SET_NARGS(1),___PRC(305),___L__23__23_clear_2d_jobs_21_)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L4__23__23_gc_2d_finalize_21_)
   ___JUMPINT(___SET_NARGS(0),___PRC(344),___L__23__23_gc_2d_final_2d_will_2d_registry_21_)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_execute_2d_final_2d_wills_21_)
   ___SET_R1(___CDR(___GLO(147,___G__23__23_final_2d_will_2d_registry)))
   ___SETCAR(___GLO(147,___G__23__23_final_2d_will_2d_registry),___GLO(147,___G__23__23_final_2d_will_2d_registry))
   ___SETCDR(___GLO(147,___G__23__23_final_2d_will_2d_registry),___NUL)
   ___IF(___NULLP(___R1))
...
___DEF_GLBL(___L__23__23_gc_2d_final_2d_will_2d_registry_21_)
   ___SET_R2(___CDR(___GLO(147,___G__23__23_final_2d_will_2d_registry)))
   ___SET_R1(___GLO(147,___G__23__23_final_2d_will_2d_registry))
...
___DEF_GLBL(___L3__23__23_gc_2d_final_2d_will_2d_registry_21_)
   ___SETCAR(___GLO(147,___G__23__23_final_2d_will_2d_registry),___R1) ___SET_R1(___GLO(147,___G__23__23_final_2d_will_2d_registry))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_make_2d_final_2d_will)
   ___SET_R3(___CDR(___GLO(147,___G__23__23_final_2d_will_2d_registry)))
   ___IF(___NOT(___NULLP(___R3)))
   ___GOTO(___L2__23__23_make_2d_final_2d_will)
   ___END_IF
   ___SETCAR(___GLO(147,___G__23__23_final_2d_will_2d_registry),___R2)
___DEF_GLBL(___L2__23__23_make_2d_final_2d_will)
   ___SETCDR(___GLO(147,___G__23__23_final_2d_will_2d_registry),___R2)
   ___SETCDR(___R2,___R3)
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_make_2d_vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(207,___G__23__23_make_2d_vector))
...
___DEF_SLBL(1,___L1__23__23_make_2d_string)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(201,___G__23__23_make_2d_string))
...
___DEF_SLBL(1,___L1__23__23_make_2d_s8vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(200,___G__23__23_make_2d_s8vector))
...
___DEF_SLBL(1,___L1__23__23_make_2d_u8vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(206,___G__23__23_make_2d_u8vector))
...
___DEF_SLBL(1,___L1__23__23_make_2d_s16vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(197,___G__23__23_make_2d_s16vector))
...
___DEF_SLBL(1,___L1__23__23_make_2d_u16vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(203,___G__23__23_make_2d_u16vector))
...
___DEF_SLBL(1,___L1__23__23_make_2d_s32vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(198,___G__23__23_make_2d_s32vector))
...
___DEF_SLBL(1,___L1__23__23_make_2d_u32vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(204,___G__23__23_make_2d_u32vector))
...
___DEF_SLBL(1,___L1__23__23_make_2d_s64vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(199,___G__23__23_make_2d_s64vector))
...
___DEF_SLBL(1,___L1__23__23_make_2d_u64vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(205,___G__23__23_make_2d_u64vector))
...
___DEF_SLBL(1,___L1__23__23_make_2d_f32vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(189,___G__23__23_make_2d_f32vector))
...
___DEF_SLBL(1,___L1__23__23_make_2d_f64vector)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(2),___PRM(190,___G__23__23_make_2d_f64vector))
...
___DEF_SLBL(1,___L1__23__23_explode_2d_continuation)
   ___JUMPINT(___SET_NARGS(1),___PRC(446),___L__23__23_continuation_2d_frame)
___DEF_SLBL(2,___L2__23__23_explode_2d_continuation)
   ___SET_STK(-1,___R1)
   ___SET_R1(___STK(-2))
   ___SET_R0(___LBL(3))
   ___JUMPINT(___SET_NARGS(1),___PRC(451),___L__23__23_continuation_2d_denv)
...
___DEF_SLBL(3,___L3__23__23_continuation_2d_frame)
   ___JUMPINT(___SET_NARGS(0),___PRC(325),___L__23__23_gc)
...
___DEF_SLBL(1,___L1__23__23_explode_2d_frame)
   ___JUMPINT(___SET_NARGS(1),___PRC(470),___L__23__23_frame_2d_fs)
___DEF_SLBL(2,___L2__23__23_explode_2d_frame)
   ___SET_STK(-1,___R1)
   ___SET_R1(___FIXADD(___R1,___FIX(1L)))
   ___SET_R0(___LBL(3))
   ___JUMPPRM(___SET_NARGS(1),___PRM(207,___G__23__23_make_2d_vector))
___DEF_SLBL(3,___L3__23__23_explode_2d_frame)
   ___SET_STK(0,___R1)
   ___SET_R1(___STK(-2))
   ___SET_R0(___LBL(4))
   ___ADJFP(4)
   ___JUMPINT(___SET_NARGS(1),___PRC(464),___L__23__23_frame_2d_ret)
...
___DEF_SLBL(8,___L8__23__23_explode_2d_frame)
   ___JUMPINT(___SET_NARGS(2),___PRC(478),___L__23__23_frame_2d_slot_2d_live_3f_)
___DEF_SLBL(9,___L9__23__23_explode_2d_frame)
   ...
   ___SET_R1(___STK(-7))
   ___SET_R0(___LBL(6))
   ___JUMPINT(___SET_NARGS(2),___PRC(482),___L__23__23_frame_2d_ref)
...
#undef ___ARG1
   ...
   ___SET_R0(___LBL(1))
   ___ADJFP(4)
   ___JUMPINT(___SET_NARGS(0),___PRC(309),___L__23__23_check_2d_heap)
...
___DEF_GLBL(___L__23__23_continuation_2d_next)
   ...
   ___SET_R0(___LBL(1))
   ___ADJFP(4)
   ___JUMPINT(___SET_NARGS(1),___PRC(486),___L__23__23_continuation_2d_copy)
___DEF_SLBL(1,___L1__23__23_continuation_2d_next)
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPINT(___SET_NARGS(1),___PRC(489),___L__23__23_continuation_2d_next_21_)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_type_2d_id)
   ___SET_R1(___UNCHECKEDSTRUCTUREREF(___R1,___FIX(1L),___GLO(339,___G__23__23_type_2d_type),___PRM(336,___G__23__23_type_2d_id)))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_type_2d_name)
   ___SET_R1(___UNCHECKEDSTRUCTUREREF(___R1,___FIX(2L),___GLO(339,___G__23__23_type_2d_type),___PRM(337,___G__23__23_type_2d_name)))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_type_2d_flags)
   ___SET_R1(___UNCHECKEDSTRUCTUREREF(___R1,___FIX(3L),___GLO(339,___G__23__23_type_2d_type),___PRM(335,___G__23__23_type_2d_flags)))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_type_2d_super)
   ___SET_R1(___UNCHECKEDSTRUCTUREREF(___R1,___FIX(4L),___GLO(339,___G__23__23_type_2d_type),___PRM(338,___G__23__23_type_2d_super)))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_type_2d_fields)
   ___SET_R1(___UNCHECKEDSTRUCTUREREF(___R1,___FIX(5L),___GLO(339,___G__23__23_type_2d_type),___PRM(334,___G__23__23_type_2d_fields)))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_type_3f_)
   ___SET_R2(___TYPEID(___GLO(339,___G__23__23_type_2d_type)))
...
___DEF_SLBL(1,___L1__23__23_structure_2d_ref)
   ___JUMPPRM(___SET_NARGS(2),___PRM(317,___G__23__23_structure_2d_instance_2d_of_3f_))
___DEF_SLBL(2,___L2__23__23_structure_2d_ref)
   ...
   ___END_IF
   ___SET_R2(___PRM(318,___G__23__23_structure_2d_ref))
...
___DEF_SLBL(2,___L2__23__23_structure_2d_set_21_)
   ...
   ___END_IF
   ___SET_R2(___PRM(319,___G__23__23_structure_2d_set_21_))
...
___DEF_GLBL(___L__23__23_direct_2d_structure_2d_ref)
   ...
   ___END_IF
   ___SET_STK(1,___R3)
   ___SET_R3(___PRM(111,___G__23__23_direct_2d_structure_2d_ref))
   ___ADJFP(1)
...
___DEF_GLBL(___L__23__23_direct_2d_structure_2d_set_21_)
   ...
   ___END_IF
   ___SET_STK(1,___R3)
   ___SET_R3(___PRM(112,___G__23__23_direct_2d_structure_2d_set_21_))
   ___ADJFP(1)
...
___DEF_SLBL(1,___L1__23__23_make_2d_interned_2d_symbol)
   ___JUMPINT(___SET_NARGS(2),___PRC(565),___L__23__23_make_2d_interned_2d_symkey)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(3,___L3__23__23_make_2d_interned_2d_symkey)
   ___JUMPINT(___SET_NARGS(2),___PRC(718),___L__20___kernel_23_0)
...
___DEF_SLBL(1,___L1__23__23_find_2d_interned_2d_symbol)
   ___JUMPINT(___SET_NARGS(2),___PRC(578),___L__23__23_find_2d_interned_2d_symkey)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_find_2d_interned_2d_symkey)
   ___JUMPINT(___SET_NARGS(2),___PRC(721),___L__20___kernel_23_1)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_make_2d_global_2d_var)
   ...
   ___SET_R0(___STK(-3))
   ___ADJFP(-4)
   ___JUMPPRM(___SET_NARGS(1),___PRM(192,___G__23__23_make_2d_global_2d_var))
...
___DEF_SLBL(1,___L1__23__23_object_2d__3e_global_2d_var_2d__3e_identifier)
   ___JUMPINT(___SET_NARGS(2),___PRC(599),___L__23__23_object_2d__3e_global_2d_var)
...
___DEF_SLBL(3,___L3__23__23_object_2d__3e_global_2d_var_2d__3e_identifier)
   ___ADJFP(-4)
   ___JUMPINT(___SET_NARGS(1),___PRC(601),___L__23__23_global_2d_var_2d__3e_identifier)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_foreign_2d_tags)
   ___JUMPINT(___SET_NARGS(1),___PRC(608),___L__23__23_foreign_2d_tags)
...
___DEF_SLBL(2,___L2_foreign_2d_tags)
   ___SET_NARGS(3) ___JUMPINT(___NOTHING,___PRC(603),___L0__23__23_fail_2d_check_2d_foreign)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_foreign_2d_released_3f_)
   ___JUMPINT(___SET_NARGS(1),___PRC(614),___L__23__23_foreign_2d_released_3f_)
...
#undef ___ARG1
   ...
   ___SET_R3(___R1)
   ___SET_R1(___R2)
   ___SET_R2(___PRC(622))
   ___ADJFP(1)
   ___SET_NARGS(4) ___JUMPINT(___NOTHING,___PRC(246),___L0__23__23_raise_2d_os_2d_exception)
...
___DEF_SLBL(1,___L1_foreign_2d_release_21_)
   ___JUMPINT(___SET_NARGS(1),___PRC(620),___L__23__23_foreign_2d_release_21_)
...
___DEF_SLBL(1,___L1__23__23_foreign_2d_address)
   ___JUMPINT(___SET_NARGS(1),___PRC(724),___L__20___kernel_23_2)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_foreign_2d_address)
   ___JUMPINT(___SET_NARGS(1),___PRC(626),___L__23__23_foreign_2d_address)
...
___DEF_SLBL(1,___L1_system_2d_version)
   ___JUMPINT(___SET_NARGS(0),___PRC(633),___L__23__23_system_2d_version)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_system_2d_version_2d_string)
   ___JUMPINT(___SET_NARGS(0),___PRC(638),___L__23__23_system_2d_version_2d_string)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L_system_2d_type)
   ___SET_R1(___GLO(278,___G__23__23_os_2d_system_2d_type_2d_saved))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L_system_2d_type_2d_string)
   ___SET_R1(___GLO(279,___G__23__23_os_2d_system_2d_type_2d_string_2d_saved))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L_configure_2d_command_2d_string)
   ___SET_R1(___GLO(215,___G__23__23_os_2d_configure_2d_command_2d_string_2d_saved))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_system_2d_stamp)
   ___SET_R1(___GLO(331,___G__23__23_system_2d_stamp_2d_saved))
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1_system_2d_stamp)
   ___JUMPINT(___SET_NARGS(0),___PRC(649),___L__23__23_system_2d_stamp)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_process_2d_statistics)
   ...
   ___SET_R0(___LBL(1))
   ___ADJFP(4)
   ___JUMPPRM(___SET_NARGS(1),___PRM(206,___G__23__23_make_2d_u8vector))
...
___DEF_SLBL(1,___L1_err_2d_code_2d__3e_string)
   ___JUMPINT(___SET_NARGS(1),___PRC(748),___L__20___kernel_23_10)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_add_2d_exit_2d_job_21_)
   ___SET_R2(___R1)
   ___SET_R1(___GLO(127,___G__23__23_exit_2d_jobs))
   ___POLL(1)
...
___DEF_SLBL(1,___L1__23__23_exit_2d_cleanup)
   ___JUMPINT(___SET_NARGS(1),___PRC(299),___L__23__23_execute_2d_and_2d_clear_2d_jobs_21_)
___DEF_SLBL(2,___L2__23__23_exit_2d_cleanup)
   ___SET_R0(___STK(-3))
   ___POLL(3)
___DEF_SLBL(3,___L3__23__23_exit_2d_cleanup)
   ___ADJFP(-4)
   ___JUMPINT(___SET_NARGS(0),___PRC(340),___L__23__23_execute_2d_final_2d_wills_21_)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_exit_2d_with_2d_err_2d_code)
   ___JUMPINT(___SET_NARGS(0),___PRC(685),___L__23__23_exit_2d_cleanup)
...
___DEF_SLBL(3,___L3__23__23_exit_2d_with_2d_err_2d_code)
   ___ADJFP(-4)
   ___JUMPINT(___SET_NARGS(1),___PRC(683),___L__23__23_exit_2d_with_2d_err_2d_code_2d_no_2d_cleanup)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_exit)
   ___JUMPINT(___SET_NARGS(1),___PRC(690),___L__23__23_exit_2d_with_2d_err_2d_code)
___END_P_SW
___END_P_COD
...
___DEF_SLBL(1,___L1__23__23_exit_2d_abnormally)
   ___SET_NARGS(1) ___JUMPINT(___NOTHING,___PRC(695),___L0__23__23_exit)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_main_2d_set_21_)
   ___SET_GLO(187,___G__23__23_main,___R1)
   ___SET_R1(___VOID)
   ___JUMPPRM(___NOTHING,___R0)
___END_P_SW
___END_P_COD
...
___DEF_GLBL(___L__23__23_execute_2d_program)
   ___SET_R1(___VECTORREF(___GLO(285,___G__23__23_program_2d_descr),___FIX(0L)))
   ___SET_STK(1,___R0)
   ___SET_R2(___FIX(1L))
   ___SET_R0(___LBL(2))
   ___ADJFP(4)
...
___DEF_SLBL(1,___L1__23__23_execute_2d_program)
   ___JUMPINT(___SET_NARGS(2),___PRC(706),___L__23__23_execute_2d_modules)
___DEF_SLBL(2,___L2__23__23_execute_2d_program)
   ___SET_R0(___STK(-3))
   ___POLL(3)
___DEF_SLBL(3,___L3__23__23_execute_2d_program)
   ___ADJFP(-4)
   ___JUMPGLONOTSAFE(___SET_NARGS(0),187,___G__23__23_main)
___END_P_SW
___END_P_COD
...
___BEGIN_LBL
 ___DEF_LBL_INTRO(___H__20___kernel," _kernel",___REF_FAL,25,0)
...
,___DEF_LBL_RET(___H__20___kernel,___IFD(___RETN,3,0,0x1L))
,___DEF_LBL_RET(___H__20___kernel,___IFD(___RETN,3,0,0x1L))
,___DEF_LBL_RET(___H__20___kernel,___IFD(___RETN,3,0,0x3L))
,___DEF_LBL_RET(___H__20___kernel,___IFD(___RETI,4,0,0x3f3L))
,___DEF_LBL_RET(___H__20___kernel,___IFD(___RETN,3,0,0x5L))
,___DEF_LBL_RET(___H__20___kernel,___IFD(___RETI,4,0,0x3f1L))
,___DEF_LBL_RET(___H__20___kernel,___IFD(___RETI,4,0,0x3f1L))
,___DEF_LBL_RET(___H__20___kernel,___IFD(___RETN,3,0,0x1L))
,___DEF_LBL_RET(___H__20___kernel,___IFD(___RETN,3,0,0x1L))
...
,___DEF_LBL_RET(___H__23__23_continuation_2d_copy,___IFD(___RETN,3,0,0x3L))
...
,___DEF_LBL_RET(___H__23__23_continuation_2d_next,___IFD(___RETN,3,0,0x1L))
...
,___DEF_LBL_RET(___H__23__23_with_2d_no_2d_result_2d_expected_2d_toplevel,___IFD(___RETN,3,0,0x1L))
...
,___DEF_LBL_RET(___H__23__23_process_2d_statistics,___IFD(___RETN,3,0,0x1L))
...
,___DEF_LBL_PROC(___H__20___kernel_23_2,1,0)
,___DEF_LBL_RET(___H__20___kernel_23_2,___IFD(___RETN,2,1,0x3L))
,___DEF_LBL_INTRO(___H__20___kernel_23_3," _kernel#3",___REF_FAL,2,0)
,___DEF_LBL_PROC(___H__20___kernel_23_3,0,0)
,___DEF_LBL_RET(___H__20___kernel_23_3,___IFD(___RETN,1,0,0x1L))
...
,___DEF_LBL_PROC(___H__20___kernel_23_6,0,0)
,___DEF_LBL_RET(___H__20___kernel_23_6,___IFD(___RETN,1,0,0x1L))
...
,___DEF_LBL_PROC(___H__20___kernel_23_9,3,0)
,___DEF_LBL_RET(___H__20___kernel_23_9,___IFD(___RETN,4,3,0xfL))
...
,___DEF_LBL_PROC(___H__20___kernel_23_13,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_14,1,0)
,___DEF_LBL_RET(___H__20___kernel_23_14,___IFD(___RETN,2,1,0x3L))
,___DEF_LBL_INTRO(___H__20___kernel_23_15," _kernel#15",___REF_FAL,2,0)
,___DEF_LBL_PROC(___H__20___kernel_23_15,0,0)
,___DEF_LBL_RET(___H__20___kernel_23_15,___IFD(___RETN,1,0,0x1L))
...
,___DEF_LBL_PROC(___H__20___kernel_23_18,2,0)
,___DEF_LBL_RET(___H__20___kernel_23_18,___IFD(___RETN,3,2,0x7L))
,___DEF_LBL_INTRO(___H__20___kernel_23_19," _kernel#19",___REF_FAL,2,0)
,___DEF_LBL_PROC(___H__20___kernel_23_19,0,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_21,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_22,2,0)
,___DEF_LBL_RET(___H__20___kernel_23_22,___IFD(___RETN,3,2,0x7L))
...
,___DEF_LBL_PROC(___H__20___kernel_23_24,3,0)
,___DEF_LBL_RET(___H__20___kernel_23_24,___IFD(___RETN,4,3,0xfL))
,___DEF_LBL_INTRO(___H__20___kernel_23_25," _kernel#25",___REF_FAL,2,0)
,___DEF_LBL_PROC(___H__20___kernel_23_25,4,0)
,___DEF_LBL_RET(___H__20___kernel_23_25,___IFD(___RETN,5,4,0x1fL))
,___DEF_LBL_INTRO(___H__20___kernel_23_26," _kernel#26",___REF_FAL,2,0)
,___DEF_LBL_PROC(___H__20___kernel_23_26,4,0)
,___DEF_LBL_RET(___H__20___kernel_23_26,___IFD(___RETN,5,4,0x1fL))
,___DEF_LBL_INTRO(___H__20___kernel_23_27," _kernel#27",___REF_FAL,2,0)
,___DEF_LBL_PROC(___H__20___kernel_23_27,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_30,2,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_31,3,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_32,4,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_34,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_35,3,0)
,___DEF_LBL_RET(___H__20___kernel_23_35,___IFD(___RETN,4,3,0xfL))
...
,___DEF_LBL_PROC(___H__20___kernel_23_41,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_44,3,0)
,___DEF_LBL_RET(___H__20___kernel_23_44,___IFD(___RETN,4,3,0xfL))
,___DEF_LBL_INTRO(___H__20___kernel_23_45," _kernel#45",___REF_FAL,2,0)
,___DEF_LBL_PROC(___H__20___kernel_23_45,3,0)
,___DEF_LBL_RET(___H__20___kernel_23_45,___IFD(___RETN,4,3,0xfL))
...
,___DEF_LBL_PROC(___H__20___kernel_23_47,2,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_48,2,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_50,6,0)
,___DEF_LBL_RET(___H__20___kernel_23_50,___IFD(___RETN,7,6,0x7fL))
,___DEF_LBL_INTRO(___H__20___kernel_23_51," _kernel#51",___REF_FAL,2,0)
,___DEF_LBL_PROC(___H__20___kernel_23_51,3,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_52,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_54,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_55,0,0)
,___DEF_LBL_RET(___H__20___kernel_23_55,___IFD(___RETN,1,0,0x1L))
,___DEF_LBL_INTRO(___H__20___kernel_23_56," _kernel#56",___REF_FAL,2,0)
,___DEF_LBL_PROC(___H__20___kernel_23_56,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_57,6,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_59,0,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_63,0,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_66,2,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_67,2,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_68,2,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_69,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_70,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_73,1,0)
...
,___DEF_LBL_PROC(___H__20___kernel_23_74,2,0)
...
___DEF_PRM(185,___G__23__23_kernel_2d_handlers,27)
___DEF_PRM(114,___G__23__23_dynamic_2d_env_2d_bind,42)
___DEF_PRM(113,___G__23__23_disable_2d_interrupts_21_,45)
___DEF_PRM(115,___G__23__23_enable_2d_interrupts_21_,47)
___DEF_PRM(182,___G__23__23_interrupt_2d_handler,49)
___DEF_PRM(184,___G__23__23_interrupt_2d_vector_2d_set_21_,51)
___DEF_PRM(181,___G__23__23_heartbeat_2d_interval_2d_set_21_,53)
___DEF_PRM(136,___G__23__23_fail_2d_check_2d_heap_2d_overflow_2d_exception,55)
___DEF_PRM(357,___G_heap_2d_overflow_2d_exception_3f_,58)
___DEF_PRM(287,___G__23__23_raise_2d_heap_2d_overflow_2d_exception,60)
___DEF_PRM(143,___G__23__23_fail_2d_check_2d_stack_2d_overflow_2d_exception,63)
___DEF_PRM(380,___G_stack_2d_overflow_2d_exception_3f_,66)
___DEF_PRM(295,___G__23__23_raise_2d_stack_2d_overflow_2d_exception,68)
___DEF_PRM(139,___G__23__23_fail_2d_check_2d_nonprocedure_2d_operator_2d_exception,71)
___DEF_PRM(366,___G_nonprocedure_2d_operator_2d_exception_3f_,74)
___DEF_PRM(364,___G_nonprocedure_2d_operator_2d_exception_2d_operator,76)
___DEF_PRM(362,___G_nonprocedure_2d_operator_2d_exception_2d_arguments,79)
___DEF_PRM(363,___G_nonprocedure_2d_operator_2d_exception_2d_code,82)
___DEF_PRM(365,___G_nonprocedure_2d_operator_2d_exception_2d_rte,85)
___DEF_PRM(81,___G__23__23_apply_2d_global_2d_with_2d_procedure_2d_check_2d_nary,88)
___DEF_PRM(83,___G__23__23_apply_2d_with_2d_procedure_2d_check_2d_nary,90)
___DEF_PRM(82,___G__23__23_apply_2d_with_2d_procedure_2d_check,92)
___DEF_PRM(291,___G__23__23_raise_2d_nonprocedure_2d_operator_2d_exception,94)
___DEF_PRM(146,___G__23__23_fail_2d_check_2d_wrong_2d_number_2d_of_2d_arguments_2d_exception,97)
___DEF_PRM(396,___G_wrong_2d_number_2d_of_2d_arguments_2d_exception_3f_,100)
___DEF_PRM(395,___G_wrong_2d_number_2d_of_2d_arguments_2d_exception_2d_procedure,102)
___DEF_PRM(394,___G_wrong_2d_number_2d_of_2d_arguments_2d_exception_2d_arguments,105)
___DEF_PRM(300,___G__23__23_raise_2d_wrong_2d_number_2d_of_2d_arguments_2d_exception_2d_nary,108)
___DEF_PRM(299,___G__23__23_raise_2d_wrong_2d_number_2d_of_2d_arguments_2d_exception,110)
___DEF_PRM(137,___G__23__23_fail_2d_check_2d_keyword_2d_expected_2d_exception,113)
___DEF_PRM(360,___G_keyword_2d_expected_2d_exception_3f_,116)
___DEF_PRM(359,___G_keyword_2d_expected_2d_exception_2d_procedure,118)
___DEF_PRM(358,___G_keyword_2d_expected_2d_exception_2d_arguments,121)
___DEF_PRM(289,___G__23__23_raise_2d_keyword_2d_expected_2d_exception_2d_nary,124)
___DEF_PRM(288,___G__23__23_raise_2d_keyword_2d_expected_2d_exception,126)
___DEF_PRM(145,___G__23__23_fail_2d_check_2d_unknown_2d_keyword_2d_argument_2d_exception,129)
___DEF_PRM(393,___G_unknown_2d_keyword_2d_argument_2d_exception_3f_,132)
___DEF_PRM(392,___G_unknown_2d_keyword_2d_argument_2d_exception_2d_procedure,134)
___DEF_PRM(391,___G_unknown_2d_keyword_2d_argument_2d_exception_2d_arguments,137)
___DEF_PRM(298,___G__23__23_raise_2d_unknown_2d_keyword_2d_argument_2d_exception_2d_nary,140)
___DEF_PRM(297,___G__23__23_raise_2d_unknown_2d_keyword_2d_argument_2d_exception,142)
___DEF_PRM(134,___G__23__23_fail_2d_check_2d_cfun_2d_conversion_2d_exception,145)
___DEF_PRM(349,___G_cfun_2d_conversion_2d_exception_3f_,148)
___DEF_PRM(348,___G_cfun_2d_conversion_2d_exception_2d_procedure,150)
___DEF_PRM(345,___G_cfun_2d_conversion_2d_exception_2d_arguments,153)
___DEF_PRM(346,___G_cfun_2d_conversion_2d_exception_2d_code,156)
___DEF_PRM(347,___G_cfun_2d_conversion_2d_exception_2d_message,159)
___DEF_PRM(286,___G__23__23_raise_2d_cfun_2d_conversion_2d_exception_2d_nary,162)
___DEF_PRM(142,___G__23__23_fail_2d_check_2d_sfun_2d_conversion_2d_exception,165)
___DEF_PRM(379,___G_sfun_2d_conversion_2d_exception_3f_,168)
___DEF_PRM(378,___G_sfun_2d_conversion_2d_exception_2d_procedure,170)
___DEF_PRM(375,___G_sfun_2d_conversion_2d_exception_2d_arguments,173)
___DEF_PRM(376,___G_sfun_2d_conversion_2d_exception_2d_code,176)
___DEF_PRM(377,___G_sfun_2d_conversion_2d_exception_2d_message,179)
___DEF_PRM(294,___G__23__23_raise_2d_sfun_2d_conversion_2d_exception,182)
___DEF_PRM(138,___G__23__23_fail_2d_check_2d_multiple_2d_c_2d_return_2d_exception,185)
___DEF_PRM(361,___G_multiple_2d_c_2d_return_2d_exception_3f_,188)
___DEF_PRM(290,___G__23__23_raise_2d_multiple_2d_c_2d_return_2d_exception,190)
___DEF_PRM(140,___G__23__23_fail_2d_check_2d_number_2d_of_2d_arguments_2d_limit_2d_exception,192)
___DEF_PRM(369,___G_number_2d_of_2d_arguments_2d_limit_2d_exception_3f_,195)
___DEF_PRM(368,___G_number_2d_of_2d_arguments_2d_limit_2d_exception_2d_procedure,197)
___DEF_PRM(367,___G_number_2d_of_2d_arguments_2d_limit_2d_exception_2d_arguments,200)
___DEF_PRM(292,___G__23__23_raise_2d_number_2d_of_2d_arguments_2d_limit_2d_exception,203)
___DEF_PRM(144,___G__23__23_fail_2d_check_2d_type_2d_exception,206)
___DEF_PRM(390,___G_type_2d_exception_3f_,209)
___DEF_PRM(388,___G_type_2d_exception_2d_procedure,211)
___DEF_PRM(387,___G_type_2d_exception_2d_arguments,214)
___DEF_PRM(386,___G_type_2d_exception_2d_arg_2d_num,217)
___DEF_PRM(389,___G_type_2d_exception_2d_type_2d_id,220)
___DEF_PRM(296,___G__23__23_raise_2d_type_2d_exception,223)
___DEF_PRM(141,___G__23__23_fail_2d_check_2d_os_2d_exception,229)
___DEF_PRM(374,___G_os_2d_exception_3f_,232)
___DEF_PRM(373,___G_os_2d_exception_2d_procedure,234)
___DEF_PRM(370,___G_os_2d_exception_2d_arguments,237)
___DEF_PRM(372,___G_os_2d_exception_2d_message,240)
___DEF_PRM(371,___G_os_2d_exception_2d_code,243)
___DEF_PRM(293,___G__23__23_raise_2d_os_2d_exception,246)
___DEF_PRM(85,___G__23__23_argument_2d_list_2d_remove_2d_absent_21_,253)
___DEF_PRM(86,___G__23__23_argument_2d_list_2d_remove_2d_absent_2d_keys_21_,258)
___DEF_PRM(84,___G__23__23_argument_2d_list_2d_fix_2d_rest_2d_param_21_,263)
___DEF_PRM(133,___G__23__23_extract_2d_procedure_2d_and_2d_arguments,267)
___DEF_PRM(154,___G__23__23_force_2d_undetermined,278)
___DEF_PRM(196,___G__23__23_make_2d_jobs,284)
___DEF_PRM(79,___G__23__23_add_2d_job_2d_at_2d_tail_21_,287)
___DEF_PRM(78,___G__23__23_add_2d_job_21_,290)
___DEF_PRM(121,___G__23__23_execute_2d_jobs_21_,293)
___DEF_PRM(119,___G__23__23_execute_2d_and_2d_clear_2d_jobs_21_,299)
___DEF_PRM(94,___G__23__23_clear_2d_jobs_21_,305)
___DEF_PRM(91,___G__23__23_check_2d_heap_2d_limit,307)
___DEF_PRM(90,___G__23__23_check_2d_heap,309)
___DEF_PRM(302,___G__23__23_rest_2d_param_2d_check_2d_heap,312)
___DEF_PRM(303,___G__23__23_rest_2d_param_2d_heap_2d_overflow,316)
___DEF_PRM(304,___G__23__23_rest_2d_param_2d_resume_2d_procedure,321)
___DEF_PRM(169,___G__23__23_gc_2d_without_2d_exceptions,323)
___DEF_PRM(165,___G__23__23_gc,325)
___DEF_PRM(77,___G__23__23_add_2d_gc_2d_interrupt_2d_job_21_,330)
___DEF_PRM(93,___G__23__23_clear_2d_gc_2d_interrupt_2d_jobs_21_,333)
___DEF_PRM(167,___G__23__23_gc_2d_finalize_21_,336)
___DEF_PRM(120,___G__23__23_execute_2d_final_2d_wills_21_,340)
___DEF_PRM(166,___G__23__23_gc_2d_final_2d_will_2d_registry_21_,344)
___DEF_PRM(191,___G__23__23_make_2d_final_2d_will,346)
___DEF_PRM(173,___G__23__23_get_2d_min_2d_heap,349)
___DEF_PRM(310,___G__23__23_set_2d_min_2d_heap_21_,351)
___DEF_PRM(172,___G__23__23_get_2d_max_2d_heap,353)
___DEF_PRM(309,___G__23__23_set_2d_max_2d_heap_21_,355)
___DEF_PRM(171,___G__23__23_get_2d_live_2d_percent,357)
___DEF_PRM(308,___G__23__23_set_2d_live_2d_percent_21_,359)
___DEF_PRM(174,___G__23__23_get_2d_standard_2d_level,361)
___DEF_PRM(311,___G__23__23_set_2d_standard_2d_level_21_,363)
___DEF_PRM(307,___G__23__23_set_2d_debug_2d_settings_21_,365)
___DEF_PRM(312,___G__23__23_still_2d_copy,367)
___DEF_PRM(314,___G__23__23_still_2d_obj_2d_refcount_2d_inc_21_,370)
___DEF_PRM(313,___G__23__23_still_2d_obj_2d_refcount_2d_dec_21_,372)
___DEF_PRM(207,___G__23__23_make_2d_vector,374)
___DEF_PRM(201,___G__23__23_make_2d_string,377)
___DEF_PRM(200,___G__23__23_make_2d_s8vector,380)
___DEF_PRM(206,___G__23__23_make_2d_u8vector,383)
___DEF_PRM(197,___G__23__23_make_2d_s16vector,386)
___DEF_PRM(203,___G__23__23_make_2d_u16vector,389)
___DEF_PRM(198,___G__23__23_make_2d_s32vector,392)
___DEF_PRM(204,___G__23__23_make_2d_u32vector,395)
___DEF_PRM(199,___G__23__23_make_2d_s64vector,398)
___DEF_PRM(205,___G__23__23_make_2d_u64vector,401)
___DEF_PRM(189,___G__23__23_make_2d_f32vector,404)
___DEF_PRM(190,___G__23__23_make_2d_f64vector,407)
___DEF_PRM(80,___G__23__23_apply,410)
___DEF_PRM(99,___G__23__23_closure_3f_,413)
___DEF_PRM(96,___G__23__23_closure_2d_length,415)
___DEF_PRM(95,___G__23__23_closure_2d_code,417)
___DEF_PRM(97,___G__23__23_closure_2d_ref,419)
___DEF_PRM(98,___G__23__23_closure_2d_set_21_,421)
___DEF_PRM(328,___G__23__23_subprocedure_3f_,423)
___DEF_PRM(322,___G__23__23_subprocedure_2d_id,425)
___DEF_PRM(325,___G__23__23_subprocedure_2d_parent,427)
___DEF_PRM(324,___G__23__23_subprocedure_2d_nb_2d_parameters,429)
___DEF_PRM(323,___G__23__23_subprocedure_2d_nb_2d_closed,431)
___DEF_PRM(202,___G__23__23_make_2d_subprocedure,433)
___DEF_PRM(326,___G__23__23_subprocedure_2d_parent_2d_info,435)
___DEF_PRM(327,___G__23__23_subprocedure_2d_parent_2d_name,437)
___DEF_PRM(131,___G__23__23_explode_2d_continuation,439)
___DEF_PRM(103,___G__23__23_continuation_2d_frame,446)
___DEF_PRM(102,___G__23__23_continuation_2d_denv,451)
___DEF_PRM(132,___G__23__23_explode_2d_frame,453)
___DEF_PRM(163,___G__23__23_frame_2d_ret,464)
___DEF_PRM(109,___G__23__23_continuation_2d_ret,466)
___DEF_PRM(305,___G__23__23_return_2d_fs,468)
___DEF_PRM(160,___G__23__23_frame_2d_fs,470)
___DEF_PRM(104,___G__23__23_continuation_2d_fs,472)
___DEF_PRM(161,___G__23__23_frame_2d_link,474)
___DEF_PRM(105,___G__23__23_continuation_2d_link,476)
___DEF_PRM(164,___G__23__23_frame_2d_slot_2d_live_3f_,478)
___DEF_PRM(110,___G__23__23_continuation_2d_slot_2d_live_3f_,480)
___DEF_PRM(162,___G__23__23_frame_2d_ref,482)
___DEF_PRM(108,___G__23__23_continuation_2d_ref,484)
___DEF_PRM(101,___G__23__23_continuation_2d_copy,486)
___DEF_PRM(107,___G__23__23_continuation_2d_next_21_,489)
___DEF_PRM(106,___G__23__23_continuation_2d_next,491)
___DEF_PRM(336,___G__23__23_type_2d_id,494)
___DEF_PRM(337,___G__23__23_type_2d_name,496)
___DEF_PRM(335,___G__23__23_type_2d_flags,498)
___DEF_PRM(338,___G__23__23_type_2d_super,500)
___DEF_PRM(334,___G__23__23_type_2d_fields,502)
___DEF_PRM(316,___G__23__23_structure_2d_direct_2d_instance_2d_of_3f_,504)
___DEF_PRM(317,___G__23__23_structure_2d_instance_2d_of_3f_,506)
___DEF_PRM(340,___G__23__23_type_3f_,510)
___DEF_PRM(320,___G__23__23_structure_2d_type,512)
___DEF_PRM(321,___G__23__23_structure_2d_type_2d_set_21_,514)
___DEF_PRM(315,___G__23__23_structure,516)
___DEF_PRM(318,___G__23__23_structure_2d_ref,525)
___DEF_PRM(319,___G__23__23_structure_2d_set_21_,533)
___DEF_PRM(111,___G__23__23_direct_2d_structure_2d_ref,541)
___DEF_PRM(112,___G__23__23_direct_2d_structure_2d_set_21_,546)
___DEF_PRM(341,___G__23__23_unchecked_2d_structure_2d_ref,551)
___DEF_PRM(342,___G__23__23_unchecked_2d_structure_2d_set_21_,553)
___DEF_PRM(329,___G__23__23_symbol_2d_table,555)
___DEF_PRM(186,___G__23__23_keyword_2d_table,557)
___DEF_PRM(194,___G__23__23_make_2d_interned_2d_symbol,559)
___DEF_PRM(193,___G__23__23_make_2d_interned_2d_keyword,562)
___DEF_PRM(195,___G__23__23_make_2d_interned_2d_symkey,565)
___DEF_PRM(149,___G__23__23_find_2d_interned_2d_symbol,572)
___DEF_PRM(148,___G__23__23_find_2d_interned_2d_keyword,575)
___DEF_PRM(150,___G__23__23_find_2d_interned_2d_symkey,578)
___DEF_PRM(192,___G__23__23_make_2d_global_2d_var,581)
___DEF_PRM(180,___G__23__23_global_2d_var_3f_,584)
___DEF_PRM(178,___G__23__23_global_2d_var_2d_ref,586)
___DEF_PRM(176,___G__23__23_global_2d_var_2d_primitive_2d_ref,588)
___DEF_PRM(179,___G__23__23_global_2d_var_2d_set_21_,590)
___DEF_PRM(177,___G__23__23_global_2d_var_2d_primitive_2d_set_21_,592)
___DEF_PRM(212,___G__23__23_object_2d__3e_global_2d_var_2d__3e_identifier,594)
___DEF_PRM(211,___G__23__23_object_2d__3e_global_2d_var,599)
___DEF_PRM(175,___G__23__23_global_2d_var_2d__3e_identifier,601)
___DEF_PRM(135,___G__23__23_fail_2d_check_2d_foreign,603)
___DEF_PRM(356,___G_foreign_3f_,606)
___DEF_PRM(158,___G__23__23_foreign_2d_tags,608)
___DEF_PRM(355,___G_foreign_2d_tags,610)
___DEF_PRM(157,___G__23__23_foreign_2d_released_3f_,614)
___DEF_PRM(354,___G_foreign_2d_released_3f_,616)
___DEF_PRM(156,___G__23__23_foreign_2d_release_21_,620)
___DEF_PRM(353,___G_foreign_2d_release_21_,622)
___DEF_PRM(155,___G__23__23_foreign_2d_address,626)
___DEF_PRM(352,___G_foreign_2d_address,629)
___DEF_PRM(332,___G__23__23_system_2d_version,633)
___DEF_PRM(384,___G_system_2d_version,635)
___DEF_PRM(333,___G__23__23_system_2d_version_2d_string,638)
___DEF_PRM(385,___G_system_2d_version_2d_string,640)
___DEF_PRM(382,___G_system_2d_type,643)
___DEF_PRM(383,___G_system_2d_type_2d_string,645)
___DEF_PRM(350,___G_configure_2d_command_2d_string,647)
___DEF_PRM(330,___G__23__23_system_2d_stamp,649)
___DEF_PRM(381,___G_system_2d_stamp,651)
___DEF_PRM(151,___G__23__23_first_2d_argument,654)
___DEF_PRM(343,___G__23__23_with_2d_no_2d_result_2d_expected,656)
___DEF_PRM(344,___G__23__23_with_2d_no_2d_result_2d_expected_2d_toplevel,659)
___DEF_PRM(282,___G__23__23_process_2d_statistics,662)
___DEF_PRM(283,___G__23__23_process_2d_times,665)
___DEF_PRM(170,___G__23__23_get_2d_current_2d_time_21_,668)
___DEF_PRM(351,___G_err_2d_code_2d__3e_string,670)
___DEF_PRM(100,___G__23__23_command_2d_line,673)
___DEF_PRM(214,___G__23__23_os_2d_condvar_2d_select_21_,675)
___DEF_PRM(76,___G__23__23_add_2d_exit_2d_job_21_,677)
___DEF_PRM(92,___G__23__23_clear_2d_exit_2d_jobs_21_,680)
___DEF_PRM(129,___G__23__23_exit_2d_with_2d_err_2d_code_2d_no_2d_cleanup,683)
___DEF_PRM(126,___G__23__23_exit_2d_cleanup,685)
___DEF_PRM(128,___G__23__23_exit_2d_with_2d_err_2d_code,690)
___DEF_PRM(124,___G__23__23_exit,695)
___DEF_PRM(125,___G__23__23_exit_2d_abnormally,698)
___DEF_PRM(130,___G__23__23_exit_2d_with_2d_exception,701)
___DEF_PRM(188,___G__23__23_main_2d_set_21_,704)
___DEF_PRM(122,___G__23__23_execute_2d_modules,706)
___DEF_PRM(123,___G__23__23_execute_2d_program,713)
___DEF_PRM(1,___G__20___kernel_23_0,718)
___DEF_PRM(2,___G__20___kernel_23_1,721)
___DEF_PRM(13,___G__20___kernel_23_2,724)
___DEF_PRM(24,___G__20___kernel_23_3,727)
___DEF_PRM(35,___G__20___kernel_23_4,730)
___DEF_PRM(46,___G__20___kernel_23_5,733)
___DEF_PRM(57,___G__20___kernel_23_6,736)
___DEF_PRM(68,___G__20___kernel_23_7,739)
___DEF_PRM(74,___G__20___kernel_23_8,742)
___DEF_PRM(75,___G__20___kernel_23_9,745)
___DEF_PRM(3,___G__20___kernel_23_10,748)
___DEF_PRM(4,___G__20___kernel_23_11,751)
___DEF_PRM(5,___G__20___kernel_23_12,754)
___DEF_PRM(6,___G__20___kernel_23_13,757)
___DEF_PRM(7,___G__20___kernel_23_14,760)
___DEF_PRM(8,___G__20___kernel_23_15,763)
___DEF_PRM(9,___G__20___kernel_23_16,766)
___DEF_PRM(10,___G__20___kernel_23_17,769)
___DEF_PRM(11,___G__20___kernel_23_18,772)
___DEF_PRM(12,___G__20___kernel_23_19,775)
___DEF_PRM(14,___G__20___kernel_23_20,778)
___DEF_PRM(15,___G__20___kernel_23_21,781)
___DEF_PRM(16,___G__20___kernel_23_22,784)
___DEF_PRM(17,___G__20___kernel_23_23,787)
___DEF_PRM(18,___G__20___kernel_23_24,790)
___DEF_PRM(19,___G__20___kernel_23_25,793)
___DEF_PRM(20,___G__20___kernel_23_26,796)
___DEF_PRM(21,___G__20___kernel_23_27,799)
___DEF_PRM(22,___G__20___kernel_23_28,802)
___DEF_PRM(23,___G__20___kernel_23_29,805)
___DEF_PRM(25,___G__20___kernel_23_30,808)
___DEF_PRM(26,___G__20___kernel_23_31,811)
___DEF_PRM(27,___G__20___kernel_23_32,814)
___DEF_PRM(28,___G__20___kernel_23_33,817)
___DEF_PRM(29,___G__20___kernel_23_34,820)
___DEF_PRM(30,___G__20___kernel_23_35,823)
___DEF_PRM(31,___G__20___kernel_23_36,826)
___DEF_PRM(32,___G__20___kernel_23_37,829)
___DEF_PRM(33,___G__20___kernel_23_38,832)
___DEF_PRM(34,___G__20___kernel_23_39,835)
___DEF_PRM(36,___G__20___kernel_23_40,838)
___DEF_PRM(37,___G__20___kernel_23_41,841)
___DEF_PRM(38,___G__20___kernel_23_42,844)
___DEF_PRM(39,___G__20___kernel_23_43,847)
___DEF_PRM(40,___G__20___kernel_23_44,850)
___DEF_PRM(41,___G__20___kernel_23_45,853)
___DEF_PRM(42,___G__20___kernel_23_46,856)
___DEF_PRM(43,___G__20___kernel_23_47,859)
___DEF_PRM(44,___G__20___kernel_23_48,862)
___DEF_PRM(45,___G__20___kernel_23_49,865)
___DEF_PRM(47,___G__20___kernel_23_50,868)
___DEF_PRM(48,___G__20___kernel_23_51,871)
___DEF_PRM(49,___G__20___kernel_23_52,874)
___DEF_PRM(50,___G__20___kernel_23_53,877)
___DEF_PRM(51,___G__20___kernel_23_54,880)
___DEF_PRM(52,___G__20___kernel_23_55,883)
___DEF_PRM(53,___G__20___kernel_23_56,886)
___DEF_PRM(54,___G__20___kernel_23_57,889)
___DEF_PRM(55,___G__20___kernel_23_58,892)
___DEF_PRM(56,___G__20___kernel_23_59,895)
___DEF_PRM(58,___G__20___kernel_23_60,898)
___DEF_PRM(59,___G__20___kernel_23_61,901)
___DEF_PRM(60,___G__20___kernel_23_62,904)
___DEF_PRM(61,___G__20___kernel_23_63,907)
___DEF_PRM(62,___G__20___kernel_23_64,910)
___DEF_PRM(63,___G__20___kernel_23_65,913)
___DEF_PRM(64,___G__20___kernel_23_66,916)
___DEF_PRM(65,___G__20___kernel_23_67,919)
___DEF_PRM(66,___G__20___kernel_23_68,922)
___DEF_PRM(67,___G__20___kernel_23_69,925)
___DEF_PRM(69,___G__20___kernel_23_70,928)
___DEF_PRM(70,___G__20___kernel_23_71,931)
___DEF_PRM(71,___G__20___kernel_23_72,934)
___DEF_PRM(72,___G__20___kernel_23_73,937)
___DEF_PRM(73,___G__20___kernel_23_74,940)
___END_MOD1
